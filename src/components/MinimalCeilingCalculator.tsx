      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-6 space-y-4">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-sm space-y-5">
            ...
            {/* TOTAL F.C QTY Highlight Card */}
            <div 
              onClick={() => setShowSplitModal(true)}
              className="bg-slate-900 text-white rounded-xl p-5 cursor-pointer hover:bg-slate-800 transition-all group shadow-md"
            ...
            <button
              type="button"
              onClick={() => setShowSplitModal(true)}
              className="w-full flex items-center justify-between px-3.5 py-2.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl text-xs font-medium text-slate-700 transition-colors group"
            >
              <div className="flex items-center gap-2">
